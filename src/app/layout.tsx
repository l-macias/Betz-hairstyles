...
export const metadata: Metadata = {
  title: "Betz Hairstyles | Peinadora Profesional en Rosario, Argentina",
  description:
  ...
  authors: [{ name: "Betz Hairstyles" }],
  creator: "Betz Hairstyles",
  openGraph: {
    type: "website",
    locale: "es_AR",
    title: "Betz Hairstyles | Peinadora Profesional en Rosario",
    description:
      "Bodas, quinceañeras, eventos sociales, editoriales y modelos. Peinados de alta gama en Rosario, Argentina.",
    siteName: "Betz Hairstyles",
  },
  twitter: {
    card: "summary_large_image",
    title: "Betz Hairstyles | Peinadora Profesional en Rosario",
    description: "Bodas, quinceañeras, eventos y editoriales. Peinados de alta gama en Rosario.",
  },
  robots: {
    index: true,
    follow: true,
...
const schema = {
  ...
  "sameAs": [
    "https://www.instagram.com/betzhairstyles"
  ]
};
